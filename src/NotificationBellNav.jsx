// src/NotificationBellNav.jsx
// Simple notification bell — click navigates to /updates (no dropdown).
// Badge shows unread count. Replaces dropdown NotificationBell for portal use.
//
// Usage:
//   import { NotificationBellNav } from '@nomadahq/sm-ui'
//   <NotificationBellNav href="/updates" />
//   <NotificationBellNav href="/updates" onNavigate={navigate} />
...
export function NotificationBellNav(props) {
