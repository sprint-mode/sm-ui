...
// ═══ ADMIN SIDEBAR ICONS ═══
export var IconAddressBook = function(p) { return <svg {...S} {...p}><path d="M16 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12"/><path d="M22 3v18"/><circle cx="10" cy="10" r="2"/><path d="M14 15.5c0-1.5-1.8-2.5-4-2.5s-4 1-4 2.5"/></svg> }
export var IconChartHistogram = function(p) { return <svg {...S} {...p}><path d="M3 3v18h18"/><rect x="7" y="13" width="3" height="5" rx="0.5"/><rect x="12" y="9" width="3" height="9" rx="0.5"/><rect x="17" y="5" width="3" height="13" rx="0.5"/></svg> }
export var IconReportMoney = function(p) { return <svg {...S} {...p}><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="2"/><path d="M14 11h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H10"/><path d="M12 17v1"/><path d="M12 10v1"/></svg> }
export var IconMoneybag = function(p) { return <svg {...S} {...p}><path d="M9.5 3h5l-2.5 4-2.5-4z"/><path d="M7 7l-1.5 2A11 11 0 0 0 4 14c0 4.4 3.6 7 8 7s8-2.6 8-7a11 11 0 0 0-1.5-5L17 7"/><path d="M14 13h-1.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H12"/><path d="M12 19v.5"/><path d="M12 12.5v.5"/></svg> }
export var IconActivityHeartbeat = function(p) { return <svg {...S} {...p}><path d="M3 12h4l3-9 4 18 3-9h4"/></svg> }
export var IconMessageCircle = function(p) { return <svg {...S} {...p}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg> }
export var IconGlobe = function(p) { return <svg {...S} {...p}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg> }
...
// Sidebar section icons (admin v2 — 9 sections)
export var IconAddressBook = function(p) { return <svg {...S} {...p}><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg> }
export var IconChartHistogram = function(p) { return <svg {...S} {...p}><rect x="2" y="12" width="4" height="10"/><rect x="9" y="7" width="4" height="15"/><rect x="16" y="2" width="4" height="20"/></svg> }
export var IconReportMoney = function(p) { return <svg {...S} {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="14" x2="15" y2="14"/><line x1="12" y1="11" x2="12" y2="17"/></svg> }
export var IconMoneybag = function(p) { return <svg {...S} {...p}><path d="M12 2C9 2 7 4 7 6c0 1 .5 2 1 2.5C5 10 3 13 3 16a8 8 0 0 0 16 0c0-3-2-6-5-7.5.5-.5 1-1.5 1-2.5 0-2-2-4-3-4z"/></svg> }
export var IconActivityHeartbeat = function(p) { return <svg {...S} {...p}><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> }
export var IconMessageCircle = function(p) { return <svg {...S} {...p}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg> }
export var IconGlobe = function(p) { return <svg {...S} {...p}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg> }
export var IconDevWindow = function(p) { return <svg {...S} {...p}><rect x="2" y="3" width="20" height="18" rx="2"/><polyline points="8 10 12 14 16 10"/></svg> }
